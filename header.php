...
<div id="page" class="site">
	<header id="masthead" class="site-header" role="banner" style="margin-bottom: 1px;">
	...
	<?php } ?>	
		...
		<html>
			...
			setInterval("document.getElementById('time').innerHTML='今天：'+new Date().toLocaleString()+' 星期'+'日一二三四五六'.charAt(new Date().getDay());",1000);
			}
			// ]]></script>
			</body>
		</html>
